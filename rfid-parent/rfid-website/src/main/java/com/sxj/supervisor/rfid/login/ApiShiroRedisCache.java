...
public class ApiShiroRedisCache<K, V> extends ShiroRedisCache<K, V>
{
    ...
    {
        ApiShiroRedisCache.collections = collections;
    }
    
    public ApiShiroRedisCache(CacheLevel level, String name)
    {
        super(level, name);
    }
