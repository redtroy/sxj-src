...
public class WindowRfidRefServiceImpl implements IWindowRfidRefService
{
            ...
            throws ServiceException
    {
        try
        {
            ...
            List<WindowRefEntity> rfidList = windowRfidRefDao.queryWindowRfidRefList(condition);
            ...
            throws ServiceException
    {
        try
        {
            ...
            CometServiceImpl.subCount(RfidChannel.WIND_MANAGER_LOGISTICS_MESSGAGE);
            RfidChannel.initTopic()
                    .publish(RfidChannel.WIND_MANAGER_LOGISTICS_MESSGAGE);
        }
        catch (Exception e)
        {
            SxjLogger.error(e.getMessage(), e, this.getClass());
    ...
    public void addWindowRfidRef(WindowRefEntity win) throws ServiceException
    {
        try
        {
            if (win != null)
            {
                ...
                CometServiceImpl.takeCount(RfidChannel.WIND_MANAGER_WINDOW_MESSGAGE_REF);
                RfidChannel.initTopic()
                        .publish(RfidChannel.WIND_MANAGER_WINDOW_MESSGAGE_REF);
            }
