...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    **/
    createui: function()
    {
        ...
        var me=this;
		var body=$("<div id=\"toolbuttons\" style=\"width:324px;height:70px;margin:auto;position: relative;padding-top:370px\">").appendTo(this.container);
		var divStr="<div>";
		if(!this.options.showTool)
			divStr="<div style=\"display:none;\">"
		
		
        $(divStr, { 'class': "iviewer_zoom_in iviewer_common iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(body);

        $(divStr, { 'class': "iviewer_zoom_out iviewer_common iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(body);
       ...
       // $("<div>", { 'class': "iviewer_zoom_fit iviewer_common iviewer_button"})
        ...
        this.zoom_object = $(divStr).addClass("iviewer_zoom_status iviewer_common")
                                    //.appendTo(this.container);
		...
		$(divStr, { 'class': "iviewer_del iviewer_common iviewer_button" })
                    .appendTo(body);
    ...
    this.load = function(src, loaded, error) {
        ...
        img.onload = function() {
            ...
            self._img
                ...
                .css({ position: "absolute", top :"0px", left: "0px", maxWidth: "none",width:"100%"});
