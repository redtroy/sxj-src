...
public class RedisCountDownLatchEntry
{
    ...
    public RedisCountDownLatchEntry(RedisCountDownLatchEntry source)
    {
    ...
    public RedisCountDownLatchEntry(Promise<Boolean> promise)
    {
        super();
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        RedisCountDownLatchEntry other = (RedisCountDownLatchEntry) obj;
