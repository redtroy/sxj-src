...
public class JsonJacksonCodec implements RedissonCodec
{
    ...
    private Object decode(ByteBuffer bytes)
    {
        try
        {
            return objectMapper.readValue(bytes.array(), bytes.arrayOffset()
                    + bytes.position(), bytes.limit(), Object.class);
        }
        catch (Exception e)
        {
    ...
    public Object decodeMapValue(ByteBuffer bytes)
    {
        try
        {
            return mapObjectMapper.readValue(bytes.array(), bytes.arrayOffset()
                    + bytes.position(), bytes.limit(), Object.class);
        }
        catch (Exception e)
        {
