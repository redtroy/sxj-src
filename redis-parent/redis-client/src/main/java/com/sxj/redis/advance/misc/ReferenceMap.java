 ...
 */
package com.sxj.redis.advance.misc;
...
public class ReferenceMap<K, V> extends AbstractMap<K, V> implements
        ConcurrentMap<K, V>
{
    ...
    private V execute(Strategy strategy, K key, V value)
    {
        ...
        return (V) strategy.execute(this,
                keyReference,
    ...
    public boolean replace(K key, V oldValue, V newValue)
    {
        ...
        return delegate.replace(keyReference,
    ...
    {
        return referenceType == ReferenceType.STRONG ? reference
    ...
    {
        return keyReferenceType == ReferenceType.STRONG ? o
                : new KeyReferenceAwareWrapper(o);
    }
    ...
    {
        return valueReferenceType == ReferenceType.STRONG ? o
                : new ReferenceAwareWrapper(o);
    }
    ...
    class SoftKeyReference extends SoftReference<Object> implements
            InternalReference
    {
        final int hashCode;
    ...
    class WeakKeyReference extends WeakReference<Object> implements
            InternalReference
    {
        final int hashCode;
    ...
    class SoftValueReference extends SoftReference<Object> implements
            InternalReference
    {
    ...
    class WeakValueReference extends WeakReference<Object> implements
            InternalReference
    {
        final Object keyReference;
        ...
        void cleanUp(Reference reference)
        {
            ...
            catch (Throwable t)
            {
                throw new IllegalStateException(
                        "Unable to clean up after reference", t);
            }
        }
    ...
    {
        Object execute(ReferenceMap map, Object keyReference,
    ...
    private enum PutStrategy implements Strategy
    {
        PUT
        {
            ...
            public Object execute(ReferenceMap map, Object keyReference,
                    Object valueReference)
            {
                return map.dereferenceValue(map.delegate.put(keyReference,
                        valueReference));
            }
        },
        ...
        REPLACE
        {
                    ...
                    Object valueReference)
            {
                ...
                do
                {
                    ...
                    if (map.delegate.replace(keyReference,
        ...
        PUT_IF_ABSENT
        {
                    ...
                    Object valueReference)
            {
                ...
                do
                {
                    existingValueReference = map.delegate.putIfAbsent(keyReference,
                            valueReference);
                    existingValue = map.dereferenceValue(existingValueReference);
                } while (isExpired(existingValueReference, existingValue));
    ...
    {
        private Iterator<Map.Entry<Object, Object>> i = delegate.entrySet()
                .iterator();
