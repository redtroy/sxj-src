 ...
 */
package com.sxj.redis.advance.connection.balancer;
...
abstract class BaseLoadBalancer implements LoadBalancer
{
            ...
            int port)
    {
        ...
        for (SubscribesConnectionEntry connectionEntry : clients)
        {
            ...
            while (true)
            {
                RedisConnection connection = connectionEntry.getConnections()
                        .poll();
                if (connection == null)
                {
                    break;
    ...
    public RedisPubSubConnection nextPubSubConnection()
    {
        ...
        List<SubscribesConnectionEntry> clientsCopy = new ArrayList<SubscribesConnectionEntry>(
                clients);
        while (true)
        {
            ...
            else
            {
                ...
                catch (RedisConnectionException e)
                {
                    ...
                    log.warn("Can't connect to {}, trying next connection!",
