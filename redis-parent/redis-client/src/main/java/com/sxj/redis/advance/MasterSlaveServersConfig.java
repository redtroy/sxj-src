...
import com.sxj.redis.advance.connection.balancer.RoundRobinLoadBalancer;
        ...
        BaseConfig<MasterSlaveServersConfig>
{
     ...
     * @return
     */
    public MasterSlaveServersConfig setSlaveConnectionPoolSize(
            int slaveConnectionPoolSize)
    {
     ...
     * @return
     */
    public MasterSlaveServersConfig setMasterConnectionPoolSize(
     ...
     * @see org.redisson.connection.balancer.BaseLoadBalancer
     */
     ...
     * @return
     */
    public MasterSlaveServersConfig setSlaveSubscriptionConnectionPoolSize(
            int slaveSubscriptionConnectionPoolSize)
    {
