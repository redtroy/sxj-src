...
public abstract class OperationListener<V, P, F> implements FutureListener<F>
{
    ...
    public OperationListener(Promise<P> promise,
            RedisAsyncConnection<Object, V> async,
            AsyncOperation<V, P> timeoutCallback)
    {
        super();
    ...
    protected boolean isBreak(RedisAsyncConnection<Object, V> async,
            Promise<P> promise, Future<F> future)
    {
        if (!future.isSuccess())
        {
