package com.sxj.spring.modules.redismq.tests;
...
import com.sxj.spring.modules.redismq.Callback;
...
public class ProducerTest extends Assert
{
    ...
    {
        publish();
        Subscriber c = new Subscriber(new Jedis("localhost"), "a subscriber",
                "foo");
        System.out.println(c.consume());
        System.out.println(c.unreadMessages());
    }
    ...
    public void eraseOldMessages()
    {
        ...
        Subscriber nc = new Subscriber(new Jedis("localhost"),
                "new subscriber", "foo");
    ...
    class SlowConsumer extends Subscriber
    {
        private long sleep;
    ...
    {
        Subscriber c = new SlowConsumer(new Jedis("localhost"), "a consumer",
                "foo", 2000L);
        Producer p = new Producer(new Jedis("localhost"), "foo");
