...
public class FastDFSImpl implements IFileUpLoad
{
    ...
    public void init()
    {
        ...
        lock = new Semaphore(getMaxThreads());
    }
            ...
            List<String> originalName)
    {
        ...
        try
        {
            ...
            {
                String file_ext_name = LocalFileUtil.getFileExtName(originalName.get(i));
                List<NameValuePair> meta_list = new ArrayList<NameValuePair>();
                meta_list.add(new NameValuePair("originalName",
                        originalName.get(i)));
    ...
    public byte[] downloadFile(String file_id)
    {
        ...
        try
        {
            Object object = HierarchicalCacheManager.get(LEVEL,
                    CACHE_NAME,
                    file_id);
            if (object != null)
            {
