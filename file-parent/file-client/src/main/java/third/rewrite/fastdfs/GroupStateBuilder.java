...
public class GroupStateBuilder {
	...
	static {
		int offset = 0;
		fieldsArray[FIELD_INDEX_GROUP_NAME] = new FieldDefinition(
				 offset, OtherConstants.FDFS_GROUP_NAME_MAX_LEN + 1);
		offset += OtherConstants.FDFS_GROUP_NAME_MAX_LEN + 1;

		fieldsArray[FIELD_INDEX_TOTAL_MB] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_FREE_MB] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TRUNK_FREE_MB] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORAGE_COUNT] = new FieldDefinition(
				 offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORAGE_PORT] = new FieldDefinition(
				 offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;
		...
		fieldsArray[FIELD_INDEX_ACTIVE_COUNT] = new FieldDefinition(
				 offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_CURRENT_WRITE_SERVER] = new FieldDefinition(
				 offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORE_PATH_COUNT] = new FieldDefinition(
				 offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;
		...
		fieldsArray[FIELD_INDEX_CURRENT_TRUNK_FILE_ID] = new FieldDefinition(
				 offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;
	...
	public static GroupState convert(byte[] bs, int offset, Charset charset) {
		...
		state.groupName = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_GROUP_NAME], charset);
		...
		state.trunkFreeMB = StateBuilderHelper.longValue(bs, offset,
				fieldsArray[FIELD_INDEX_TRUNK_FREE_MB]);
		state.storageCount = StateBuilderHelper.intValue(bs, offset,
		...
		state.activeCount = StateBuilderHelper.intValue(bs, offset,
