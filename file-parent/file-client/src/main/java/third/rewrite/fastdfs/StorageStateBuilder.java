...
public class StorageStateBuilder {
	...
	static {
		...
		fieldsArray[FIELD_INDEX_ID] = new FieldDefinition(offset,
				OtherConstants.FDFS_STORAGE_ID_MAX_SIZE);
		offset += OtherConstants.FDFS_STORAGE_ID_MAX_SIZE;

		fieldsArray[FIELD_INDEX_IP_ADDR] = new FieldDefinition(offset,
				OtherConstants.FDFS_IPADDR_SIZE);
		offset += OtherConstants.FDFS_IPADDR_SIZE;

		fieldsArray[FIELD_INDEX_DOMAIN_NAME] = new FieldDefinition(offset,
				OtherConstants.FDFS_DOMAIN_NAME_MAX_SIZE);
		offset += OtherConstants.FDFS_DOMAIN_NAME_MAX_SIZE;

		fieldsArray[FIELD_INDEX_SRC_IP_ADDR] = new FieldDefinition(offset,
				OtherConstants.FDFS_IPADDR_SIZE);
		offset += OtherConstants.FDFS_IPADDR_SIZE;

		fieldsArray[FIELD_INDEX_VERSION] = new FieldDefinition(offset,
				OtherConstants.FDFS_VERSION_SIZE);
		offset += OtherConstants.FDFS_VERSION_SIZE;

		fieldsArray[FIELD_INDEX_JOIN_TIME] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_UP_TIME] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_MB] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_FREE_MB] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_UPLOAD_PRIORITY] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORE_PATH_COUNT] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUBDIR_COUNT_PER_PATH] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_CURRENT_WRITE_PATH] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORAGE_PORT] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_STORAGE_HTTP_PORT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_UPLOAD_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_UPLOAD_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_APPEND_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_APPEND_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_MODIFY_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_MODIFY_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_TRUNCATE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_TRUNCATE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_SET_META_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_SET_META_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_DELETE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_DELETE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_DOWNLOAD_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_DOWNLOAD_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_GET_META_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_GET_META_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_CREATE_LINK_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_CREATE_LINK_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_DELETE_LINK_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_DELETE_LINK_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_UPLOAD_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_UPLOAD_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_APPEND_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_APPEND_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_MODIFY_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_MODIFY_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_DOWNLOAD_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_DOWNLOAD_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_SYNC_IN_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_SYNC_IN_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_SYNC_OUT_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_SYNC_OUT_BYTES] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_FILE_OPEN_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_FILE_OPEN_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_FILE_READ_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_FILE_READ_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_TOTAL_FILE_WRITE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_SUCCESS_FILE_WRITE_COUNT] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_LAST_SOURCE_UPDATE] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_LAST_SYNC_UPDATE] = new FieldDefinition(offset,
				OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_LAST_SYNCED_TIMESTAMP] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;

		fieldsArray[FIELD_INDEX_LAST_HEART_BEAT_TIME] = new FieldDefinition(
				offset, OtherConstants.FDFS_PROTO_PKG_LEN_SIZE);
		offset += OtherConstants.FDFS_PROTO_PKG_LEN_SIZE;
	...
	public static StorageState convert(byte[] bs, int offset, Charset charset) {
		...
		state.status = StateBuilderHelper.byteValue(bs, offset,
				fieldsArray[FIELD_INDEX_STATUS]);
		state.id = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_ID], charset);
		state.ipAddr = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_IP_ADDR], charset);
		state.srcIpAddr = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_SRC_IP_ADDR], charset);
		state.domainName = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_DOMAIN_NAME], charset);
		state.version = StateBuilderHelper.stringValue(bs, offset,
				fieldsArray[FIELD_INDEX_VERSION], charset);
		state.totalMB = StateBuilderHelper.longValue(bs, offset,
				fieldsArray[FIELD_INDEX_TOTAL_MB]);
		state.freeMB = StateBuilderHelper.longValue(bs, offset,
				fieldsArray[FIELD_INDEX_FREE_MB]);
		state.uploadPriority = StateBuilderHelper.intValue(bs, offset,
				fieldsArray[FIELD_INDEX_UPLOAD_PRIORITY]);
		state.joinTime = StateBuilderHelper.dateValue(bs, offset,
				fieldsArray[FIELD_INDEX_JOIN_TIME]);
		state.upTime = StateBuilderHelper.dateValue(bs, offset,
				fieldsArray[FIELD_INDEX_UP_TIME]);
		state.storePathCount = StateBuilderHelper.intValue(bs, offset,
		...
		state.storagePort = StateBuilderHelper.intValue(bs, offset,
				fieldsArray[FIELD_INDEX_STORAGE_PORT]);
		state.storageHttpPort = StateBuilderHelper.intValue(bs, offset,
				fieldsArray[FIELD_INDEX_STORAGE_HTTP_PORT]);
		state.currentWritePath = StateBuilderHelper.intValue(bs, offset,
				fieldsArray[FIELD_INDEX_CURRENT_WRITE_PATH]);
		state.totalUploadCount = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalAppendCount = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalModifyCount = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalDeleteCount = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalUploadBytes = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalAppendBytes = StateBuilderHelper.longValue(bs, offset,
		...
		state.totalModifyBytes = StateBuilderHelper.longValue(bs, offset,
		...
		state.successDownloadloadBytes = StateBuilderHelper.longValue(bs,
				offset, fieldsArray[FIELD_INDEX_SUCCESS_DOWNLOAD_BYTES]);
		state.totalSyncInBytes = StateBuilderHelper.longValue(bs, offset,
		...
		state.lastSourceUpdate = StateBuilderHelper.dateValue(bs, offset,
				fieldsArray[FIELD_INDEX_LAST_SOURCE_UPDATE]);
		state.lastSyncUpdate = StateBuilderHelper.dateValue(bs, offset,
		...
		state.isTrunkServer = StateBuilderHelper.booleanValue(bs, offset,
