...
import com.sxj.statemachine.component.IdProvider;
import com.sxj.statemachine.fsm.StateMachine.StateMachineEvent;
import com.sxj.statemachine.fsm.StateMachine.StateMachineListener;
import com.sxj.statemachine.fsm.StateMachine.TransitionBeginEvent;
import com.sxj.statemachine.fsm.StateMachine.TransitionBeginListener;
import com.sxj.statemachine.fsm.StateMachine.TransitionCompleteEvent;
import com.sxj.statemachine.fsm.StateMachine.TransitionCompleteListener;
import com.sxj.statemachine.fsm.StateMachine.TransitionEndEvent;
import com.sxj.statemachine.fsm.StateMachine.TransitionEndListener;
import com.sxj.statemachine.fsm.StateMachine.TransitionEvent;
import com.sxj.statemachine.fsm.annotation.OnAfterActionExecuted;
import com.sxj.statemachine.fsm.annotation.OnBeforeActionExecuted;
import com.sxj.statemachine.fsm.annotation.OnTransitionBegin;
import com.sxj.statemachine.fsm.annotation.OnTransitionComplete;
import com.sxj.statemachine.fsm.annotation.OnTransitionDecline;
import com.sxj.statemachine.fsm.annotation.OnTransitionEnd;
...
public class UntypedStateMachineTest
{
    ...
    static class UntypedStateMachineSample extends AbstractUntypedStateMachine
    {
        ...
        protected void fromAToB(String from, String to, TestEvent event,
                Integer context)
        {
            mockObject.fromAToB(from, to, event, context);
        }
        
        protected void ontoB(String from, String to, TestEvent event,
                Integer context)
        {
        }
        
        protected void transitFromdToaOntoA(String from, String to,
                TestEvent event, Integer context)
        {
    ...
    public void testUntypedStateMachine()
    {
        ...
        callSequence.verify(mockedObject, Mockito.times(1)).fromAToB("a",
                "b",
                TestEvent.toB,
                1);
        callSequence.verify(mockedObject, Mockito.times(1))
                .transitFromdToaOntoA("d", "a", TestEvent.toA, 4);
    }
    ...
    public void testTransitionEvent()
    {
        ...
        fsm.addStateMachineListener(new StateMachineListener<UntypedStateMachine, Object, Object, Object>()
        {
            ...
            public void stateMachineEvent(
                    StateMachineEvent<UntypedStateMachine, Object, Object, Object> event)
            {
                smCallTimes.incrementAndGet();
            }
        });
        fsm.addListener(TransitionEvent.class,
                new StateMachineListener<UntypedStateMachine, Object, Object, Object>()
                {
                    @Override
                    public void stateMachineEvent(
                            StateMachineEvent<UntypedStateMachine, Object, Object, Object> event)
        ...
        fsm.addTransitionEndListener(new TransitionEndListener<UntypedStateMachine, Object, Object, Object>()
        {
            ...
            public void transitionEnd(
                    TransitionEndEvent<UntypedStateMachine, Object, Object, Object> event)
            {
        ...
        fsm.addTransitionBeginListener(new TransitionBeginListener<UntypedStateMachine, Object, Object, Object>()
        {
            ...
            public void transitionBegin(
                    TransitionBeginEvent<UntypedStateMachine, Object, Object, Object> event)
            {
        ...
        fsm.addTransitionCompleteListener(new TransitionCompleteListener<UntypedStateMachine, Object, Object, Object>()
        {
            ...
            public void transitionComplete(
                    TransitionCompleteEvent<UntypedStateMachine, Object, Object, Object> event)
            {
    ...
    static class TestListenTarget
    {
        ...
        @OnTransitionComplete
        public void transitionComplete(String from, String to, TestEvent event,
                Integer context)
        {
        ...
        @OnTransitionDecline
        public void transitionDeclined(String from, TestEvent event,
                Integer context)
        {
        ...
        public void transitionAction(String from, String to, TestEvent event,
                Integer context, int[] mOfn)
        {
            assertTrue(from.equals("a"));
            assertTrue(to.equals("b"));
            assertTrue(event == TestEvent.toB);
        ...
        public void afterTransitionAction(String from, String to,
                TestEvent event, Integer context, int[] mOfn)
        {
    ...
    @Transitions({ @Transit(from = "a", to = "b", on = "toB") })
    static class UntypedStateMachineSample2 extends AbstractUntypedStateMachine
            implements ParamtersAnnotationPlaceHolder
    {
    }
    ...
    @Transitions({ @Transit(from = "a", to = "b", on = "toB") })
    @StateMachineParameters(stateType = String.class, eventType = TestEvent.class, contextType = Integer.class)
    static class UntypedStateMachineSampleEx1 extends
    ...
    {
        UntypedStateMachineBuilder builder = StateMachineBuilderFactory.create(UntypedStateMachineSampleEx1.class,
                int.class);
        UntypedStateMachineSampleEx1 fsmEx = builder.newUntypedStateMachine("a",
                123);
    ...
    @Transitions({ @Transit(from = "a", to = "b", on = "toB") })
    @StateMachineParameters(stateType = String.class, eventType = TestEvent.class, contextType = Integer.class)
    static class UntypedStateMachineSampleEx2 extends
            AbstractUntypedStateMachine
    {
    ...
    {
        UntypedStateMachineBuilder builder = StateMachineBuilderFactory.create(UntypedStateMachineSampleEx2.class,
                Integer.class,
                String.class);
        UntypedStateMachineSampleEx2 fsmEx = builder.newUntypedStateMachine("a",
                10,
                "Hello World");
    ...
    public void testActionExecutionPosition()
    {
        ...
        UntypedStateMachineSampleEx2 fsm = builder.newUntypedStateMachine("a",
                10,
                "Hello World");
    ...
    public void testCreateUntypedStateMachineWithExtraTwoParamsExportAndImport()
    {
        ...
        UntypedStateMachineBuilder importedBuilder = new UntypedStateMachineImporter().importDefinition(fsmEx.exportXMLDefinition(false));
        UntypedStateMachineSampleEx2 fsmEx2 = importedBuilder.newUntypedStateMachine("a",
                11,
                "Hello World!");
    ...
    @StateMachineParameters(stateType = String.class, eventType = TestEvent.class, contextType = Integer.class)
    static class UntypedStateMachineSampleEx3 extends
            AbstractUntypedStateMachine
    {
    }
