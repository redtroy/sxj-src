 ...
 *     {@link com.sxj.statemachine.StateMachines} helper, the current state
 ...
 *     cause inconsistencies. So, the {@link com.sxj.statemachine.strategy.ReentrantStrategy}
 *     allows the same thread to consume events during a transition whereas the 
 *     {@link com.sxj.statemachine.strategy.NonReentrantStrategy} is more restrictive
