...
public class EnumStateMachine_T
{
    ...
    enum Something implements com.sxj.statemachine.interfaces.State
    {
        One, Two, Three
    }
    ...
    public void stringParsingFromExistingEnumMachine() throws ParseException
    {
        ...
        StateMachineStringParser.configureStateMachine(Something.class,
    ...
    public void stringParsingFromExistingStringMachine() throws ParseException
    {
        ...
        StateMachineStringParser.configureStateMachine(String.class,
                stringRepresentation,
                esm2);
    ...
    public void entryAndExitCallbacks()
    {
        ...
        Assert.assertEquals("expected one entrance marker",
                1,
                entered.intValue());
